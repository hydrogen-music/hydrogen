 ...
 *  of CPU load. This makes it an excellent choice for especially
 *  older hardware or big setups consisting of numerous real-time
 *  programs. 
 *
 ...
 *
 * For a more thorough introduction to both entities and their
 * interaction please see \ref generalDesign
 *
 * \subsection structureCore Core
 * It consists of a \b core, which is, among others, responsible for
 * generating all audio sounds, holding a representation of all
 * patterns, drumkits etc., for all interactions with, the operation
 * system and its audio driver and for interpreting and sending MIDI
 * signals. Within this folder you can find another separation into
 * the header files in
 ...
 *
 * Since this project grew naturally and quite big already, the
 ...
 * To still provide an overview about separate topic, the
 ...
 * functions of the core while \ref docGUI encapsulate everything
 * related to the Qt5 GUI.
 *
 * \subsection structureGD General Design
 * The code of Hydrogen grew quite complex in time and it can take a
 * lot of energy and time to learn how it works by the documentation
 * of the individual classes let alone its source code. To ease this
 * pain and to get new developers/contributors started more quickly,
 * we provide some articles giving a general and more accessible
 * overview about selected topics.
 *
 ...
 * or by filing an issue on your
 * [GitHub](https://github.com/hydrogen-music/hydrogen) page.
 *
 * \section contribute Want to contribute?
 *
 * Hydrogen is a community-driven project and depends on the
 * commitment of volunteers. So, even if you are not an experienced
 * C++ developer (yet), there are countless ways to contribute to this
 * project, like improving the documentation and manual, translating
 * the user manual, tweaking the design, a donation (for huge work of
