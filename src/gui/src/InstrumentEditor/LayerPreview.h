...
class LayerPreview :  public QWidget, protected WidgetWithScalableFont<5, 6, 7>,  public H2Core::Countable<LayerPreview>, public H2Core::Object, public EventListener
{
