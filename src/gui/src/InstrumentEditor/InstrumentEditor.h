...
/// Instrument Editor
///
class InstrumentEditor :  public QWidget, protected WidgetWithScalableFont<10, 12, 14>,  public H2Core::Countable<InstrumentEditor>, public H2Core::Object, public EventListener
{
