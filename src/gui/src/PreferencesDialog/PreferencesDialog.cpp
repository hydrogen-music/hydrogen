...
PreferencesDialog::PreferencesDialog(QWidget* parent)
 ...
 , m_nCurrentId( 0 ) {
	...
	new ColorTreeItem( 0x305, pTopLevelItem, "Automation Background" );
	new ColorTreeItem( 0x306, pTopLevelItem, "Automation Line" );
	new ColorTreeItem( 0x307, pTopLevelItem, "Automation Node" );
...
void PreferencesDialog::setColorById( int nId, const QColor& color,
	...
	case 0x304:  pColorTheme->m_songEditor_textColor = color;
		break;
	case 0x305:  pColorTheme->m_songEditor_automationBackgroundColor = color;
		break;
