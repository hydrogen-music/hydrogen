...
public:
	enum class Action {
		...
		ExportDrumkit			 = 519,
		ImportDrumkit			 = 520,
		ImportOnlineDrumkit		 = 521,

		AddInstrument			 = 522,
		ClearAllInstruments		 = 523,
		AddComponent			 = 524,

		ShowPlaylist			 = 525,
		ShowDirector			 = 526,
		ShowMixer				 = 527,
		ShowInstrumentRack		 = 528,
		ShowAutomation			 = 529,
		ShowTimeline			 = 530,
		ShowPlaybackTrack		 = 531,
		ShowFullscreen			 = 532,

		InputInstrument			 = 533,
		InputDrumkit			 = 534,
		ShowPreferencesDialog	 = 535,

		ShowAudioEngineInfo		 = 536,
		ShowFilesystemInfo		 = 537,
		LogLevelNone			 = 538,
		LogLevelError			 = 539,
		LogLevelWarning			 = 540,
		LogLevelInfo			 = 541,
