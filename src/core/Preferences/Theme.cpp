...
ColorTheme::ColorTheme()
	...
	, m_componentEditor_componentColor( QColor( 127, 133, 150 ) )
	...
	, m_sampleEditor_panEnvelopeColor( QColor( 234, 130, 255 ) )
...
void ColorTheme::saveTo( XMLNode& parent ) const {
	...
	XMLNode componentEditorNode =
		colorThemeNode.createNode( "componentEditor" );
	componentEditorNode.write_color(
		"componentColor", m_componentEditor_componentColor
	);
	componentEditorNode.write_color(
		"componentTextColor", m_componentEditor_componentTextColor
	);
	componentEditorNode.write_color(
		"layerColor", m_componentEditor_layerColor
	);
	componentEditorNode.write_color(
	...
	sampleEditorNode.write_color(
		"backgroundColor", m_sampleEditor_backgroundColor
	);
	sampleEditorNode.write_color(
...
std::shared_ptr<ColorTheme> ColorTheme::loadFrom( const XMLNode& parent,
	...
	const XMLNode componentEditorNode =
		parent.firstChildElement( "componentEditor" );
	if ( !componentEditorNode.isNull() ) {
		pColorTheme->m_componentEditor_componentColor =
			componentEditorNode.read_color(
				"componentColor", pColorTheme->m_componentEditor_componentColor,
				false, false, bSilent
			);
		pColorTheme->m_componentEditor_componentTextColor =
			componentEditorNode.read_color(
				"componentTextColor",
				pColorTheme->m_componentEditor_componentTextColor, false, false,
				bSilent
			);
		pColorTheme->m_componentEditor_layerColor =
			componentEditorNode.read_color(
				"layerColor", pColorTheme->m_componentEditor_layerColor, false,
				false, bSilent
			);
		pColorTheme->m_componentEditor_layerTextColor =
			componentEditorNode.read_color(
				"layerTextColor", pColorTheme->m_componentEditor_layerTextColor,
				false, false, bSilent
			);
	}
	else {
	...
	if ( !sampleEditorNode.isNull() ) {
		pColorTheme->m_sampleEditor_backgroundColor = sampleEditorNode.read_color(
			"backgroundColor", pColorTheme->m_sampleEditor_backgroundColor, false,
			false, bSilent
		);
	...
	if ( ! bShort ) {
		sOutput =
			QString( "%1[ColorTheme]\n" )
				...
				.append(
					QString( "%1%2m_songEditor_automationBackgroundColor: %3\n"
					)
						.arg( sPrefix )
						.arg( s )
				...
				.append(
					QString( "%1%2m_songEditor_stackedModeOnNextColor: %3\n" )
						.arg( sPrefix )
						.arg( s )
						.arg( m_songEditor_stackedModeOnNextColor.name() )
				)
				.append(
					QString( "%1%2m_songEditor_stackedModeOffNextColor: %3\n" )
						.arg( sPrefix )
						.arg( s )
				...
				.append(
					QString( "%1%2m_patternEditor_selectedRowTextColor: %3\n" )
						.arg( sPrefix )
						.arg( s )
				...
				.append(
					QString( "%1%2m_patternEditor_noteVelocityFullColor: %3\n" )
						.arg( sPrefix )
						.arg( s )
				...
				.append(
					QString(
						"%1%2m_patternEditor_noteVelocityDefaultColor: %3\n"
					)
						.arg( sPrefix )
						.arg( s )
				...
				.append(
					QString( "%1%2m_patternEditor_noteVelocityHalfColor: %3\n" )
						.arg( sPrefix )
						.arg( s )
						.arg( m_patternEditor_noteVelocityHalfColor.name() )
				)
				.append(
					QString( "%1%2m_patternEditor_noteVelocityZeroColor: %3\n" )
						.arg( sPrefix )
						.arg( s )
				...
				.append(
					QString( "%1%2m_patternEditor_instrumentRowTextColor: %3\n"
					)
						.arg( sPrefix )
						.arg( s )
				...
				.append(
					QString(
						"%1%2m_patternEditor_instrumentAlternateRowColor: %3\n"
					)
						.arg( sPrefix )
						.arg( s )
				...
				.append(
					QString(
						"%1%2m_patternEditor_instrumentSelectedRowColor: %3\n"
					)
						.arg( sPrefix )
						.arg( s )
				...
				.append(
					QString( "%1%2m_patternEditor_"
							 "instrumentSelectedRowTextColor: %3\n" )
						.arg( sPrefix )
						.arg( s )
						.arg( m_patternEditor_instrumentSelectedRowTextColor
								  .name() )
				)
				.append( QString( "%1%2m_componentEditor_componentColor: %3\n"
				)
							 .arg( sPrefix )
							 .arg( s )
							 .arg( m_componentEditor_componentColor.name() ) )
				.append(
					QString( "%1%2m_componentEditor_componentTextColor: %3\n" )
						.arg( sPrefix )
						.arg( s )
						.arg( m_componentEditor_componentTextColor.name() )
				)
				.append( QString( "%1%2m_componentEditor_layerColor: %3\n" )
							 .arg( sPrefix )
							 .arg( s )
							 .arg( m_componentEditor_layerColor.name() ) )
				.append( QString( "%1%2m_componentEditor_layerTextColor: %3\n"
				)
							 .arg( sPrefix )
							 .arg( s )
							 .arg( m_componentEditor_layerTextColor.name() ) )
				.append( QString( "%1%2m_sampleEditor_backgroundColor: %3\n"
				)
							 .arg( sPrefix )
							 .arg( s )
							 .arg( m_sampleEditor_backgroundColor.name() ) )
				.append( QString( "%1%2m_sampleEditor_textColor: %3\n"
				)
							 .arg( sPrefix )
							 .arg( s )
		...
		sOutput =
			QString( "[ColorTheme] " )
				...
				.append( QString( ", m_songEditor_textColor: %1" )
							 .arg( m_songEditor_textColor.name() ) )
				.append(
					QString( ", m_songEditor_automationBackgroundColor: %1" )
						.arg( m_songEditor_automationBackgroundColor.name() )
				)
				...
				.append( QString( ", m_patternEditor_textColor: %1" )
							 .arg( m_patternEditor_textColor.name() ) )
				.append(
					QString( ", m_patternEditor_noteVelocityFullColor: %1" )
						.arg( m_patternEditor_noteVelocityFullColor.name() )
				)
				.append(
					QString( ", m_patternEditor_noteVelocityDefaultColor: %1" )
						.arg( m_patternEditor_noteVelocityDefaultColor.name() )
				)
				.append(
					QString( ", m_patternEditor_noteVelocityHalfColor: %1" )
						.arg( m_patternEditor_noteVelocityHalfColor.name() )
				)
				.append(
					QString( ", m_patternEditor_noteVelocityZeroColor: %1" )
						.arg( m_patternEditor_noteVelocityZeroColor.name() )
				)
				...
				.append( QString( ", m_patternEditor_instrumentRowColor: %1" )
							 .arg( m_patternEditor_instrumentRowColor.name() ) )
				.append(
					QString( ", m_patternEditor_instrumentRowTextColor: %1" )
						.arg( m_patternEditor_instrumentRowTextColor.name() )
				)
				.append(
					QString( ", m_patternEditor_instrumentAlternateRowColor: %1"
					)
						.arg( m_patternEditor_instrumentAlternateRowColor.name()
						)
				)
				.append(
					QString( ", m_patternEditor_instrumentSelectedRowColor: %1"
					)
						.arg( m_patternEditor_instrumentSelectedRowColor.name()
						)
				)
				.append(
					QString(
						", m_patternEditor_instrumentSelectedRowTextColor: %1"
					)
						.arg( m_patternEditor_instrumentSelectedRowTextColor
								  .name() )
				)
				.append( QString( ", m_componentEditor_componentColor: %1" )
							 .arg( m_componentEditor_componentColor.name() ) )
				.append(
					QString( ", m_componentEditor_componentTextColor: %1" )
						.arg( m_componentEditor_componentTextColor.name() )
				)
				.append( QString( ", m_componentEditor_layerColor: %1" )
							 .arg( m_componentEditor_layerColor.name() ) )
				.append( QString( ", m_componentEditor_layerTextColor: %1" )
							 .arg( m_componentEditor_layerTextColor.name() ) )
				.append( QString( ", m_sampleEditor_backgroundColor: %1"
				)
							 .arg( m_sampleEditor_backgroundColor.name() ) )
				...
				.append( QString( ", m_selectionInactiveColor: %1" )
							 .arg( m_selectionInactiveColor.name() ) )
				.append(
					QString( ", m_windowColor: %1" ).arg( m_windowColor.name() )
				)
				.append( QString( ", m_windowTextColor: %1" )
							 .arg( m_windowTextColor.name() ) )
				.append(
					QString( ", m_baseColor: %1" ).arg( m_baseColor.name() )
				)
				.append( QString( ", m_alternateBaseColor: %1" )
							 .arg( m_alternateBaseColor.name() ) )
				.append(
					QString( ", m_textColor: %1" ).arg( m_textColor.name() )
				)
				.append(
					QString( ", m_buttonColor: %1" ).arg( m_buttonColor.name() )
				)
				.append( QString( ", m_buttonTextColor: %1" )
							 .arg( m_buttonTextColor.name() ) )
				.append(
					QString( ", m_lightColor: %1" ).arg( m_lightColor.name() )
				)
				.append( QString( ", m_midLightColor: %1" )
							 .arg( m_midLightColor.name() ) )
				.append( QString( ", m_midColor: %1" ).arg( m_midColor.name() )
				)
				.append(
					QString( ", m_darkColor: %1" ).arg( m_darkColor.name() )
				)
				...
				.append( QString( ", m_toolTipTextColor: %1" )
							 .arg( m_toolTipTextColor.name() ) )
				.append(
					QString( ", m_accentColor: %1" ).arg( m_accentColor.name() )
				)
				.append( QString( ", m_accentTextColor: %1" )
							 .arg( m_accentTextColor.name() ) )
				.append(
					QString( ", m_widgetColor: %1" ).arg( m_widgetColor.name() )
				)
				...
				.append( QString( ", m_playheadColor: %1" )
							 .arg( m_playheadColor.name() ) )
				.append(
					QString( ", m_cursorColor: %1" ).arg( m_cursorColor.name() )
				)
				.append(
					QString( ", m_muteColor: %1" ).arg( m_muteColor.name() )
				)
