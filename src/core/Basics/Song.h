...
\brief	Song class
*/
class Song : public H2Core::Countable<Song>, public H2Core::Object, public std::enable_shared_from_this<Song>
{
		H2_OBJECT(Song)
	public:
		enum SongMode {
...
*/
class SongReader : public H2Core::Countable<SongReader>, public H2Core::Object
{
