...
class CoreActionController : public H2Core::Object<CoreActionController> {
   ...
   public:
	...
	static bool renameComponent( int nComponentId, const QString& sNewName );
	...
	static bool removeFromPlaylist(
