...
class Files : public H2Core::Object<Files>
{
	...
	public:
		 ...
		 */
		static inline QString savePatternNew( const QString& fileName,
		 ...
		 * \return filePath on success, NULL on failure
		 */
		static inline QString savePatternOver( const QString& fileName,
											   std::shared_ptr<Pattern> pattern,
											   std::shared_ptr<Song> song,
											   const QString& drumkitName )
		{
			return savePattern( SAVE_OVERWRITE, fileName, pattern, song,
								drumkitName );
		}
		 ...
		 */
		static inline QString savePatternPath( const QString& filePath,
											   std::shared_ptr<Pattern> pattern,
											   std::shared_ptr<Song> song,
											   const QString& drumkitName )
		{
		 ...
		 * \return filePath on success, NULL on failure
		 */
		static inline QString savePatternTmp( const QString& fileName,
											  std::shared_ptr<Pattern> pattern,
											  std::shared_ptr<Song> song,
											  const QString& drumkitName )
		{
	...
	private:
		static QString savePattern( SaveMode mode, const QString& fileName,
