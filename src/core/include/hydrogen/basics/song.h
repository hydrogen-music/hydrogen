...
inline float Song::get_fill_value() const {
	return __fill_value;
}

inline void Song::set_fill_value( float fill_value ) {
	__fill_value = fill_value;
}

inline float Song::get_fill_randomize() const {
	return __fill_randomize;
}

inline void Song::set_fill_randomize( float fill_randomize ) {
