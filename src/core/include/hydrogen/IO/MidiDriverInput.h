...
#ifndef H2_MIDI_DRIVER_INPUT_H
#define H2_MIDI_DRIVER_INPUT_H
...
/**
 * MIDI input driver base class
 */
class MidiDriverInput : public virtual Object
{
public:
	MidiDriverInput( const char* class_name );
	virtual ~MidiDriverInput();
